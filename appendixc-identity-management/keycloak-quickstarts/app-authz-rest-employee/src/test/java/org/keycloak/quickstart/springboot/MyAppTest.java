...
public class MyAppTest {
    ...
    public void testAliceAccess() throws IOException {
        // arjan can access his information
        HttpResponse response = makeRequest("http://localhost:8080/api/arjan", "arjan", "arjan");
        assertAccessGranted(response, "arjan");

        // arjan can not access information about werner
        response = makeRequest("http://localhost:8080/api/werner", "arjan", "arjan");
    ...
    public void testJdoeAccess() throws IOException {
        // arjan can access his information
        HttpResponse response = makeRequest("http://localhost:8080/api/werner", "werner", "werner");
        assertAccessGranted(response, "werner");

        // werner can access information about arjan because he is granted with "people-manager" role
        response = makeRequest("http://localhost:8080/api/arjan", "werner", "werner");
        assertAccessGranted(response, "arjan");
    }
